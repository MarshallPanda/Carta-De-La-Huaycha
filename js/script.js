...
var menu5 = new menu(5, 'Menu Classic', 'Sandwich: Poulet Grillé, Avocat, Sauce César + Frites + Boisson', 11.0, 'img/112.jpg', 'PlatosTipicos');
var menu6 = new menu(6, 'Menu Classic', 'Dessert: Tarte aux Pommes + Boisson', 4.5, 'img/113.jpg', 'PlatosTipicos');
var menu7 = new menu(7, 'Menu Classic', 'Boisson: Soda, Eau, Jus de Fruits', 2.0, 'img/114.jpg', 'PlatosTipicos');
